...
function checkingLogin(uname,pass){
  uname1=null;
  $.ajax({
    url: "http://104.155.125.243/gameonphp/login.php",
    type: "post",
      ...
      setTimeout(function(){ swal("User isn't registered!"); }, 50);
        ...
        $.each(data,function(i,item){
          ...
          if(item.profile_picture!=null  && item.profile_picture!="")
          {
            ...
            //picture in menu
            x.setAttribute("src", "http://104.155.125.243/gameonphp/upload/"+item.profile_picture);

            //picture in profile page
            y.setAttribute("src", "http://104.155.125.243/gameonphp/upload/"+item.profile_picture);

          }
          else {

            //picture in menu
            x.setAttribute("src", "http://104.155.125.243/gameonphp/upload/user.png");

            //picture in profile page
            y.setAttribute("src", "http://104.155.125.243/gameonphp/upload/user.png");
          }
          //saving the user id
          uname1=item.user_id;
          //for welcoming him
...
function addUser(uname,firstname,lastname,pass,email,birthdate,city,foot,imageAddress){
  var bool;
  $.ajax({
    url: "http://104.155.125.243/gameonphp/addUser.php",
    type: "post",
...
function addGame(game_date,game_location,start_time,end_time,min_players,max_players,permanent,ball,pump,water,net,public_game,uname,end_date,sent){
  $.ajax({
    url: "http://104.155.125.243/gameonphp/addGame.php",
    type: "post",
  ...
  function selectAllGame(){
    ...
    $.ajax({
      url: "http://104.155.125.243/gameonphp/selectGames.php",
      type: "post",
  ...
  function selectAllGameForUserApprove(){
    ...
    var time=today.getHours()+":"+today.getMinutes();
    $.ajax({
      url: "http://104.155.125.243/gameonphp/selectGamesForYou.php",
      type: "post",
  ...
  function gamesDeatils(game_id){
    //  pageIsLoading();
    $.ajax({
      url: "http://104.155.125.243/gameonphp/game_deatils.php",
      type: "post",
  ...
  function showPlayersListToAjax(game_id,user_choice){
    ...
    $.ajax({
      url: "http://104.155.125.243/gameonphp/show_players_list.php",
      type: "post",
  ...
  function joinInvitationToAjax(user_id,game_id,user_choice){
    //swal(game_id);
    $.ajax({
      url: "http://104.155.125.243/gameonphp/update_game_invation.php",
      type: "post",
  ...
  function selectAllGameUserCreated(){
    ...
    $.ajax({
      url: "http://104.155.125.243/gameonphp/selectGamesUserCreated.php",
      type: "post",
      data:{date: date, time:time, uname:uname},
      success: function(data){
        if(data.length!=0)
  ...
  function deleteGame(game_id){
    ...
    $.ajax({
      url: "http://104.155.125.243/gameonphp/delete_game.php",
      type: "post",
      data:{game_id:game_id},
      success: function(data){
  ...
  function updateGame(game_id,game_date,game_location,start_time,end_time,max_players,permanent,public_game,end_date){
    ...
    $.ajax({
      url: "http://104.155.125.243/gameonphp/update_game.php",
      type: "post",
          ...
          $.each(data,function(i,item){
            if(item.game_id!=null){
              ...
              // If another user brings a ball
                ...
                $.ajax({
                  url: "http://104.155.125.243/gameonphp/user_deatils.php",
                  type: "post",
                  data:{user:item.ball},
                  success: function(data){
