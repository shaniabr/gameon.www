...
function loginLocalStorage(){
  ...
  if(user_image!="null"  && user_image!="")
  {
    ...
    x.setAttribute("src", "http://104.155.125.243/gameonphp/upload/"+user_image);

    //picture in profile page
    y.setAttribute("src", "http://104.155.125.243/gameonphp/upload/"+user_image);
...
var deviceReady = false;
   ...
   function uploadPicture() {
     ...
     var img = document.getElementById('img');
       ...
       server = "http://104.155.125.243/gameonphp/upload.php";
