...
{
    x.setAttribute("src", "http://35.205.36.101/gameonphp/upload/"+user_image);

    //picture in profile page
    y.setAttribute("src", "http://35.205.36.101/gameonphp/upload/"+user_image);
  }
  //from facebook//
  else {
...
var deviceReady = false;
   ...
   function uploadPicture() {
     ...
     var img = document.getElementById('img');
       ...
       server = "http://35.205.36.101/gameonphp/upload.php";
