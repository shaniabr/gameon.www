...
function selectPlayersNotInvited(gameid){
  ...
  $.ajax({
    url: "http://35.240.115.18/gameonphp/selectAllPlayersNotInvited.php",
    type: "post",
    data:{gameid:gameid},
...
function checkPassedGames(uname){
  ...
  $.ajax({
    url: "http://35.240.115.18/gameonphp/selectGamesThatOver.php",
    type: "post",
...
function   updateRanking(playerId){
  ...
  setTimeout(function(){   swal("You can't rank yourself!");},50);
    ...
    $.ajax({
      url: "http://35.240.115.18/gameonphp/update_rank_user.php",
      type: "post",
  ...
  function selectAllNotiOfPlayer(uname){
    ...
    $.ajax({
      url: "http://35.240.115.18/gameonphp/selectAllNoti.php",
      type: "post",
      data:{uname: uname},
      success: function(data){
        if(data.length!=0)
  ...
  function updateGameNoti(noti_id,game_id){
    ...
    $.ajax({
      url: "http://35.240.115.18/gameonphp/update_noti.php",
      type: "post",
  ...
  function selectAlluserd(){
    pageIsLoading();
    $.ajax({
      url: "http://35.240.115.18/gameonphp/selectAllUsers.php",
      type: "get",
      success: function(data){
  ...
  function calculateAllNotiOfPlayer(uname){
    ...
    $.ajax({
      url: "http://35.240.115.18/gameonphp/calculateNumNoti.php",
      type: "post",
      data:{uname: uname},
      success: function(data){
        if(data.length!=0)
...
//  alert("fbid: "+fbid+ " email: "+email+" firstName: "+firstName+" lastName: "+lastName+" birthday: "+ birthday+" location: "+location+" picture: " +fbpic  );
  ...
  $.ajax({
    url: "http://35.240.115.18/gameonphp/addUserFromFB.php",
    type: "post",
