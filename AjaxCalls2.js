...
//shani//
           ...
           $.ajax({
                  ...
                  url: "http://35.233.58.223/gameonphp/add_game_invation.php",
                  ...
                  //  alert("The user "+u_id+"  was invited!");
                      ...
                      $.ajax({
                             url: "http://35.233.58.223/gameonphp/add_game_invation_for_creator.php",
                             type: "post",
                               data:{game_id: game_id,u_id: u_id},
                             success: function(data){
          ...
          $.ajax({
                  url: "http://35.233.58.223/gameonphp/allusersButYou.php",
                  type: "post",
                  data:{uname:uname},
                  success: function(data){
                    emptyList();
...
$('#addPlayersToGame').listview('refresh');
           ...
           //selecting the last games
              function lastGame(picked_Users){
                var g_id;
               $.ajax({
                       url: "http://35.233.58.223/gameonphp/selectLastGameId.php",
                       type: "get",
                       success: function(data){
                       $.each(data,function(i,item){
                 ...
                 //updateGameAccess
                    function updateGameAccess(game_id, ball, pump, water, net){
                      pageIsLoading();
                     $.ajax({
                             url: "http://35.233.58.223/gameonphp/updateGameAccessories.php",
                             type: "post",
...
// checks if the user name is already exists//
                        function functionCheckUserName(uname){
                          var exsist=false;
                           $.ajax({
                                   url: "http://35.233.58.223/gameonphp/connection.php",
                                   type: "post",
                                     data:{uname: uname},
                                   success: function(data){
                                     if(data.length==0)
                          ...
                          return exsist;
                             ...
                             //selecting all fields from db
                                function selectAllFields(){
                                 ...
                                 $.ajax({
                                         url: "http://35.233.58.223/gameonphp/selectAllFields.php",
                                         type: "get",
                                         success: function(data){
                  ...
                  $('#fields-list').append('<li><a href="#" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-right ui-icon-myicon2 loadinfo" onclick="fieldsDeatils(\'' +item.field_id+ '\');"><img src="http://35.233.58.223/gameonphp/upload/'+item.field_img+'"><h1>'+item.field_name+':'+' '+item.city+' </h1><p>'+item.address+'</p></a></li>').listview('refresh');
                            });
                            hideLoading();
  ...
  //add the deatils for a field
                          function fieldsDeatils(field_id){
                           ...
                           $.ajax({
                                   url: "http://35.233.58.223/gameonphp/field_deatils.php",
                                   type: "post",
                                      ...
                                      document.getElementById("hours-field").innerHTML=item.hours;
                                       ...
                                       document.getElementById("city-field").innerHTML=item.city;
                                        ...
                                        var x = document.getElementById("field-img");
                                          ...
                                          x.setAttribute("src", "http://35.233.58.223/gameonphp/upload/"+item.field_img);
                             ...
                             // check if xsist invitation for user to this game
                               function checkIfInvitationExsist(user_id,  game_id, user_choice){
                                 var bool=true;
                                 $.ajax({
                                         url: "http://35.233.58.223/gameonphp/check_game_invitation.php",
                                         type: "post",
...
// get the last rank in league for the new team's rank
                             function getLastRankLeauge(){
                               $.ajax({
                                       url: "http://35.233.58.223/gameonphp/selectTableLeague.php",
                                       type: "get",
                                       success: function(data){
                             ...
                             function checkTeamName(team_name,shirt,symbool,rank,uname){
                               $.ajax({
                                       url: "http://35.233.58.223/gameonphp/team_deatils.php",
                                       type: "post",
                             ...
                             function addTeam(team_name,shirt,symbool,rank,uname){
                               $.ajax({
                                       url: "http://35.233.58.223/gameonphp/add_team.php",
                                       type: "post",
                             ...
                             function addTeamToLeague(team_name,rank){
                               $.ajax({
                                       url: "http://35.233.58.223/gameonphp/insert_teamToLeague.php",
                                       type: "post",
                            ...
                            //updating user game_deatils-team's field
                             function updateUserTeam(uname,team_name){
                               $.ajax({
                                       url: "http://35.233.58.223/gameonphp/update_user_team.php",
                                       type: "post",
                             ...
                             function getUserTeam(uname){
                               $.ajax({
                                       url: "http://35.233.58.223/gameonphp/team_deatils_of_player.php",
                                       type: "post",
                                         data:{uname: uname},
                                       success: function(data){
                                          if(data.length!=0)
